...
def make_model():
    ...
    first_dense = tf.keras.layers.Dense(
        200, activation="relu", kernel_regularizer=regularizers.l2(0.0001)
    )(first_game)
    ...
    hidden1 = tf.keras.layers.Dense(
        400, activation="relu", kernel_regularizer=regularizers.l2(0.0001)
    )(merge)
    dropout1 = Dropout(0.5)(hidden1)
    hidden2 = tf.keras.layers.Dense(
        100, activation="relu", kernel_regularizer=regularizers.l2(0.0001)
    )(dropout1)
...
WWinning_t, BWinning_t, WWinning_test, BWinning_test = train_test_split(
    WWinning, BWinning
)
