...
def setup(starting_position: str = chess.STARTING_FEN, local_predictions=False) -> Game:
    ...
    print(
        f"========== > Setup. Test Random number: {np.random.randint(0, 123456789)}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Run self-play or puzzle solver')
    parser.add_argument('--type', type=str, default='selfplay',
                        choices=('selfplay', 'puzzles'), help='selfplay or puzzles')
    parser.add_argument('--puzzle-file', type=str, default=None,
                        help='File to load puzzles from (csv)')
